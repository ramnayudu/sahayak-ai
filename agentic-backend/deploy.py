...
# Load environment variables first, before importing sahayakai modules
load_dotenv()

from sahayakai.agent import root_agent  # Importing the root agent instance
import vertexai
...
def create() -> None:
    ...
    remote_agent = agent_engines.create(
        ...
        extra_packages=["./sahayakai"],  # Path to the local package
    )
